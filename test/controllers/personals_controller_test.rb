...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference("Personal.count") do
      post personals_url, params: { personal: { email: @personal.email, first_name: @personal.first_name, last_name: @personal.last_name, nick_name: @personal.nick_name, phone: @personal.phone } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { email: @personal.email, first_name: @personal.first_name, last_name: @personal.last_name, nick_name: @personal.nick_name, phone: @personal.phone } }
